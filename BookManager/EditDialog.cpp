...
IMPLEMENT_CLASS(EditDialog,wxDialog)

BEGIN_EVENT_TABLE(EditDialog,wxDialog)
   EVT_BUTTON(ID_EDIT_RESET,EditDialog::OnReset)
END_EVENT_TABLE()
...
EditDialog::EditDialog(wxWindow *parent,wxWindowID id,const wxString &caption,const wxPoint &pos,const wxSize &size,long style)
{
   Init();
   Create(parent,id,caption,pos,size,style);
}

inline void EditDialog::Init()
{
   book = temp;
}

bool EditDialog::Create(wxWindow *parent,wxWindowID id,const wxString &caption,const wxPoint &pos,const wxSize &size,long style)
{
...
void EditDialog::CreateControls()
{
   ...
   wxStaticText *explain = new wxStaticText(this,wxID_STATIC,wxT("Edit Book"),wxDefaultPosition,wxDefaultSize,0);
   ...
   wxTextCtrl *name_ctrl = new wxTextCtrl(this,ID_EDIT_BOOK_NAME,wxT("Book Name"),wxDefaultPosition,wxDefaultSize,0);
   ...
   wxTextCtrl *author_ctrl = new wxTextCtrl(this,ID_EDIT_AUTHOR,wxT("Author"),wxDefaultPosition,wxDefaultSize,0);
   ...
   wxTextCtrl *publisher_ctrl = new wxTextCtrl(this,ID_EDIT_PUBLISHER,wxT("Publisher"),wxDefaultPosition,wxDefaultSize,0);
   ...
   wxTextCtrl *isbn_ctrl = new wxTextCtrl(this,ID_EDIT_ISBN,wxT("ISBN"),wxDefaultPosition,wxDefaultSize,0);
   ...
   wxSpinCtrl *year_spin = new wxSpinCtrl(this,ID_EDIT_YEAR,wxEmptyString,wxDefaultPosition,wxSize(60,-1),wxSP_ARROW_KEYS,0,2012,0);
   ...
   wxSpinCtrl *quantity_spin = new wxSpinCtrl(this,ID_EDIT_QUANTITY,wxEmptyString,wxDefaultPosition,wxSize(60,-1),wxSP_ARROW_KEYS,0,1000,0);
   ...
   wxButton *reset = new wxButton(this,ID_EDIT_RESET,wxT("&Reset"),wxDefaultPosition,wxDefaultSize,0);
...
bool EditDialog::TransferDataToWindow()
{
   wxTextCtrl *name_ctrl = (wxTextCtrl*)FindWindow(ID_EDIT_BOOK_NAME);
   wxTextCtrl *author_ctrl = (wxTextCtrl*)FindWindow(ID_EDIT_AUTHOR);
   wxTextCtrl *publisher_ctrl = (wxTextCtrl*)FindWindow(ID_EDIT_PUBLISHER);
   wxTextCtrl *isbn_ctrl = (wxTextCtrl*)FindWindow(ID_EDIT_ISBN);
   wxSpinCtrl *year_spin = (wxSpinCtrl*)FindWindow(ID_EDIT_YEAR);
   wxSpinCtrl *quantity_spin = (wxSpinCtrl*)FindWindow(ID_EDIT_QUANTITY);
...
void EditDialog::OnReset(wxCommandEvent &event)
{
   Init();
